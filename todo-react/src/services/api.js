...
// SAME as Vue version - vanilla JavaScript works in React too!
...
class ApiService {
  ...
  // NOTE: Caller is responsible for navigation (using navigate('/login') in React)
...
// All React components import the same apiService - no need to instantiate it multiple times
